		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Feedback Form For Goods &amp; Supply",
									"targetURL": "#comkpofeedbackformforgoodsupply-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkpofeedbackformforgoodsupply-display": {
								"semanticObject": "comkpofeedbackformforgoodsupply",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.feedbackformforgoodsupply",
									"url": sap.ui.require.toUrl("com/kpo/feedbackformforgoodsupply")
								}
							}
						}
					}
